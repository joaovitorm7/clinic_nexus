...
export declare class AgendamentoService {
    ...
    constructor(agendamentoRepository: Repository<Agendamento>, pacienteRepository: Repository<Paciente>, medicoRepository: Repository<Medico>, funcionarioRepository: Repository<Funcionario>, agendaRepository: Repository<Agenda>);
